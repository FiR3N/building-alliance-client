      ...
      <div className={classNames(cls.reviewsContent, "container")}>
        ...
        <div className={cls.reviewsItems}>
          ...
          <div className={cls.reviewsItem}>
            ...
            <div className={cls.reviewsItemText}>
              <blockquote className="default-text">
                "Строительная организация ОАО "Спецстроймеханизация" г.
                Молодечно выполняет значительный объем работ по строительству
                объектов г. Молодечно и Молодечненского района и явялется
                основным подрядчиком по благоустройству территории и прокладке
                наружных инженерных сетей. С участием ОАО "Спецстроймеханизация"
                были построены следующие объекты: ТИЗ-1, ТИЗ-2,
